...
export const paidAdPages: Record<string, PaidAdPage> = {
	...
	"hair-restoration-denver": {
		...
		description: "Book a private, provider-led hair loss consultation in Greenwood Village to discuss available options and candidacy.",
		...
		subhead: "A private, provider-led consultation to discuss hair changes, candidacy, and available options near Denver.",
		audienceTitle: "Start with the cause, not a package",
		// {{CLINICAL_REVIEW}} Hair-loss treatment, candidacy, and outcome language requires clinical and Google Ads policy approval before launch.
	...
	"trt-denver": {
		...
		description: "Draft, disabled page for a provider-led, in-person testosterone therapy consultation in Greenwood Village near Denver.",
		...
		subhead: "A provider-led, in-person consultation for men to review symptoms, health history, labs, and whether testosterone therapy is appropriate.",
	...
	"bhrt-denver": {
		...
		description: "Draft, disabled page for a provider-led, in-person bioidentical hormone therapy consultation for women near Denver.",
		...
		subhead: "A provider-led, in-person consultation for women to review symptoms, history, labs, and whether bioidentical hormone therapy is appropriate.",
