...
The paid Google Ads routes use the same verified categories:

| Paid route | Zenoti route |
| --- | --- |
| `/dermal-fillers-denver/`, `/kybella-denver/`, `/chemical-peels-denver/`, `/bbl-laser-denver/`, `/hair-restoration-denver/` | Aesthetics category |
| `/trt-denver/`, `/bhrt-denver/` | Wellness category; pages remain disabled unless `PUBLIC_ENABLE_HORMONE_AD_PAGES=true` |
